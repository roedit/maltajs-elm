...
var _user$project$Content$defaultClassesWith = function (customClasses) {
	return A2(
		...
		A2(
			_elm_lang$core$Basics_ops['++'],
			_elm_lang$core$Native_List.fromArray(
				[_user$project$Content$defaultClasses]),
			customClasses));
};
...
var _user$project$Form$isFormInvalid = function (model) {
	...
	return (_elm_lang$core$String$isEmpty(model.name) || (_elm_lang$core$String$isEmpty(model.surname) || _elm_lang$core$String$isEmpty(model.email))) || _elm_lang$core$Basics$not(isMailOk);
};
...
var _user$project$Shared$initialModel = function () {
	...
	return {registered: false, signed: false, error: '', formModel: _user$project$Form$initialModel, headerModel: headerInitialModel};
}();
var _user$project$Shared$Model = F5(
	function (a, b, c, d, e) {
		return {registered: a, signed: b, error: c, formModel: d, headerModel: e};
	});
var _user$project$Shared$StickyHeaderMsg = function (a) {
	return {ctor: 'StickyHeaderMsg', _0: a};
};
var _user$project$Shared$FormMsg = function (a) {
	return {ctor: 'FormMsg', _0: a};
};
var _user$project$Shared$PostFail = function (a) {
	return {ctor: 'PostFail', _0: a};
};
var _user$project$Shared$PostSucceed = function (a) {
...
var _user$project$HttpUtils$registerMe = function (model) {
	...
	return A3(
		_elm_lang$core$Task$perform,
		_user$project$Shared$PostFail,
		_user$project$Shared$PostSucceed,
		A2(
			_evancz$elm_http$Http$fromJson,
			_user$project$HttpUtils$decoder,
			A2(_evancz$elm_http$Http$send, _evancz$elm_http$Http$defaultSettings, request)));
};
...
var _user$project$Main$renderAlert = function (model) {
	return _user$project$Form$isFormInvalid(model.formModel) ? A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('alert alert-danger small col-xs-12 col-sm-9')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[])),
				_user$project$Content$formErrorView
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('We apologize, something went wrong.')
					])),
				A2(
				_elm_lang$html$Html$p,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('hide')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('alert alert-success small')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
		...
		switch (_p0.ctor) {
			...
			default:
				...
				return {
					...
					_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Shared$StickyHeaderMsg, headerCmd)
				};
		}
	});
...
_elm_lang$core$Native_Platform.addPublicModule(Elm['Content'], 'Content', typeof _user$project$Content$main === 'undefined' ? null : _user$project$Content$main);
Elm['Form'] = Elm['Form'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Form'], 'Form', typeof _user$project$Form$main === 'undefined' ? null : _user$project$Form$main);
Elm['HttpUtils'] = Elm['HttpUtils'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['HttpUtils'], 'HttpUtils', typeof _user$project$HttpUtils$main === 'undefined' ? null : _user$project$HttpUtils$main);
Elm['Main'] = Elm['Main'] || {};
...
_elm_lang$core$Native_Platform.addPublicModule(Elm['Shared'], 'Shared', typeof _user$project$Shared$main === 'undefined' ? null : _user$project$Shared$main);
