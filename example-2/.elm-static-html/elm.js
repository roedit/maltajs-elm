...
var _user$project$Main$viewForRender = function () {
	var _p1 = _user$project$Main$init;
	var initialModel = _p1._0;
	var initialCommand = _p1._1;
	return _user$project$Main$view(initialModel);
}();
...
var _user$project$Main$AMessage = {ctor: 'AMessage'};
		...
		init: {
			...
			_1: _user$project$PrivateMain$htmlOut(
				A2(
					...
					{
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'index.html', _1: _user$project$Main$viewForRender},
						_1: {ctor: '[]'}
					}))
		},
		update: F2(
