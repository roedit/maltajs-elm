...
var _eeue56$elm_html_in_elm$ElmHtml_ToString$nodeToStringWithOptions = function (options) {
	return function (_p13) {
		return A2(
			_elm_lang$core$String$join,
			options.newLines ? '\n' : '',
			A2(_eeue56$elm_html_in_elm$ElmHtml_ToString$nodeToLines, options, _p13));
	};
};
...
var _user$project$StickyHeader$view = F3(
			...
			A2(
				...
				function (b) {
					return A2(
						...
						{
							ctor: '::',
							_0: A3(_user$project$StickyHeader$makeLink, activeIndex, -1, b),
							_1: {ctor: '[]'}
						});
				},
				config.brand));
...
var _user$project$StickyHeader$Config = F3(
	function (a, b, c) {
		return {logo: a, brand: b, links: c};
	});
...
var _user$project$Shared$initialModel = {registered: false, signed: false, error: '', formModel: _user$project$Form$initialModel};
var _user$project$Shared$Model = F4(
	function (a, b, c, d) {
		return {registered: a, signed: b, error: c, formModel: d};
	});
...
var _user$project$Main$viewAbout = function (model) {
	return A2(
...
var _user$project$Main$viewHeader = F2(
	function (headerCollapsed, active) {
		var links = A2(
			_elm_lang$core$List$map,
			function (_p0) {
				var _p1 = _p0;
		...
		var config = A3(
			_user$project$StickyHeader$Config,
			_elm_lang$core$Maybe$Just(logo),
			_elm_lang$core$Maybe$Just(brand),
			links);
		return A3(_user$project$StickyHeader$view, config, headerCollapsed, active);
	});
var _user$project$Main$view = function (model) {
	...
	return A2(
		...
		{
			ctor: '::',
			_0: A2(_user$project$Main$viewHeader, false, _elm_lang$core$Maybe$Nothing),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$section,
				...
				_1: {
					ctor: '::',
					_0: _user$project$Main$viewAbout(model),
					_1: {
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html$div,
		...
		},
		{
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('We apologize, something went wrong.'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
...
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_p2.ctor) {
			case 'Register':
				var signed = A2(_elm_lang$core$Debug$log, 'signed', !model.signed);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
			...
			default:
				var _p3 = A2(_user$project$Form$update, _p2._0, model.formModel);
				var updatedFormModel = _p3._0;
		...
		init: {
			...
			_1: _user$project$PrivateMain$htmlOut(
				A2(
					...
					{
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'index.html', _1: _user$project$Main$initialView},
						_1: {ctor: '[]'}
					}))
		},
		update: F2(
